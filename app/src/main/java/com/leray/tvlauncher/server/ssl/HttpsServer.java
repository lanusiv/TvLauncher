...
public class HttpsServer implements HttpServerRequestCallback {

	private static final String TAG = "HttpsServer";
	...
	private static HttpsServer mHttpServer;
	...
	public static void start(Context context, Handler handler) {
		...
		if (mHttpServer == null) {
			mHttpServer = new HttpsServer(context);
		}
		try {
