package com.leray.carousel.controls;
 ...
 * Carousel class
 *
 * ref: https://www.codeproject.com/Articles/146145/Android-D-Carousel
 *      https://github.com/rameshkec85/Android-VerticalCarousel/blob/master/src/com/carouseldemo/controls/Carousel.java
 */
public class Carousel extends CarouselSpinner implements GestureDetector.OnGestureListener {
    ...
    private boolean movePrevious() {
        int selection = getSelectedItemPosition() + 1;
        if (selection >= getCount()) {
            selection = 0;
        }
        scrollToChild(selection);
        return true;
    }
    ...
    public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
        ...
        Log.i("Carousel", "velocityX: " + velocityX);
...
//            angle += 360.0f;
    ...
    private void Calculate3DPosition(CarouselItem child, int diameter, float angleOffset){
        ...
        // modification area
        z = z - 120;
        y = - getHeight()/2 + (float) (z * Math.sin(mTheta)) + 500;  // 690
//        Log.i("Carousel", "child: " + child.getName() + ", x:" + x + ", y:" + y + ", z:" + z + ", angle: " + angleOffset);
        // change view appearance during scroll angles
        mOnItemSelectedListener.onItemRotate(child, angleOffset);
        /// end
