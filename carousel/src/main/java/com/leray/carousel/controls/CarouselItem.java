...
import com.leray.carousel.custom.BitmapUtils;
...
public class CarouselItem extends FrameLayout
    ...
    public CarouselItem(Context context, LayoutParams layoutParams) {
...
//        mText.setVisibility(GONE);
    ...
    public void setImageBitmap(Bitmap bitmap) {
        ...
        this.bitmap = bitmap;
//		this.blurBitmap = BitmapUtils.fastblur(bitmap, 1, 20);
//        this.blurBitmap = BitmapUtils.blur(context, bitmap);
    }
    ...
    public void blur(boolean blur) {
        if (blur) {
            mImage.setImageBitmap(blurBitmap);
        } else {
            mImage.setImageBitmap(bitmap);
        }
    }
